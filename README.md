# vl-ui-video-player
![GitHub issues](https://img.shields.io/github/issues-raw/milieuinfo/webcomponent-vl-ui-video-player) ![GitHub pull requests](https://img.shields.io/github/issues-pr-raw/milieuinfo/webcomponent-vl-ui-video-player) ![GitHub release (latest SemVer)](https://img.shields.io/github/v/release/milieuinfo/webcomponent-vl-ui-video-player)

Een toegankelijke video speler met HTML5, YouTube en Vimeo ondersteuning.

## Installatie
``` bash
$ npm install --save vl-ui-video-player
```

## API
De [API](https://webcomponenten.omgeving.vlaanderen.be/doc/VlVideo-player.html) bevat een overzicht van de ondersteunde attributen en een beschrijving van de beschikbare functies.

## Demo
De [demo](https://webcomponenten.omgeving.vlaanderen.be/demo/vl-video-player.html) pagina bevat een overzicht van de mogelijkheden met code voorbeelden. Lokaal opstarten kan met onderstaand [NPM](https://www.npmjs.com) script.
``` bash
$ npm run demo
```
...
## Versionering
We gebruiken [Semantic Versioning](https://semver.org) en voorzien elke release van release notes, zie een overzicht van de [releases](https://github.com/milieuinfo/webcomponent-vl-ui-video-player/releases).
...
## Credits
Zie de lijst van [ontwikkelaars](https://github.com/milieuinfo/webcomponent-vl-ui-video-player/graphs/contributors) die meegewerkt hebben aan de webcomponent.
