...
## API
De [API](https://webcomponenten.omgeving.vlaanderen.be/doc/VlVideoPlayer.html) bevat een overzicht van de ondersteunde attributen en een beschrijving van de beschikbare functies.
